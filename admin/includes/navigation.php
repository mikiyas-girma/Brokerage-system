<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">BROKERAGE SYSTEM JIMMA</a>
    </div>
    <!-- Top Menu Items -->
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#properties_dropdown"><i
                        class="fa fa-fw fa-arrows-v"></i> properties <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="properties_dropdown" class="collapse">
                    <li>
                        <a href="./properties.php">View All properties</a>
                    </li>
                    <li>
                        <a href="./properties.php?source=add_post">Add properties</a>
                    </li>
                </ul>
            </li>
