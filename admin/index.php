...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class='huge'>
                                        <?php echo $post_counts = recordCount('properties'); ?>
                                    </div>
                                    <div>properties</div>
                                </div>
                            </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class='huge'>
                                        <?php echo $comments_counts = recordCount('comments'); ?>
                                    </div>
                                    <div>Comments</div>
                                </div>
                            </div>
            ...
            $post_published_counts = checkStatus('properties', 'post_status', 'published');

            $post_draft_counts = checkStatus('properties', 'post_status', 'draft');
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            $element_text = ['All properties', 'Active properties', 'Draft properties', 'Comments', 'Unapproved Comments', 'Users', 'Subscribers Users', 'Categories'];
