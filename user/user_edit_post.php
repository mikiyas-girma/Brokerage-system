<?php
    ...
    if (isset($_POST['update_post'])) 
    {
       ...
       $query = "UPDATE properties SET post_category_id = $post_category_id, post_title = '$post_title', 
        ...
        echo "<p class='text-center text-success bg-success'>Post Updated. <a href='../post.php?p_id=$the_get_post_id'> View Post</a> Or <a href='properties.php'>Edit More properties</a></p>";
