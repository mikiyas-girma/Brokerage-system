<div class="table-responsive">
    <table class="table table-responsive table-hover table-bordered">
        ...
        <tbody>
            ...
            <?php //Showing all comments
            

            if (isset($_SESSION['username'])) {
                $session_username = $_SESSION['username'];
            }
            $query = "SELECT * FROM comments WHERE comment_receiver = '$session_username' ";
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                $comment_receiver = $row['comment_receiver'];
                ...
                //   echo "<td>$comment_receiver</td>";
            
                $query = "SELECT * FROM properties WHERE post_id = $comment_post_id";
                ...
                while ($row = mysqli_fetch_array($result_show)) {
                    ...
                    echo "<td><a class='btn btn-primary' href='../postHome.php?p_id=$post_id  & p_user=$post_user'>" . implode(' ', array_slice(explode(' ', $post_title), 0, 2)) . "</a></td>";
                }
